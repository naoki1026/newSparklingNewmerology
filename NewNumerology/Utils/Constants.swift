...
struct AppColors {
  ...
  static let blue = UIColor(red: 0/255, green: 81/255, blue: 204/255, alpha: 1.0)
  static let darkBlue = UIColor(red: 13/255, green: 13/255, blue: 128/255, alpha: 1.0)
  static let purple = UIColor(red: 149/255, green: 69/255, blue: 230/255, alpha: 1.0)
  static let wineRed = UIColor(red: 128/255, green: 39/255, blue: 63/255, alpha: 1.0)
  static let gray = UIColor(red: 128/255, green: 128/255, blue: 128/255, alpha: 1.0)
